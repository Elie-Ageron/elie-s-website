...
export const cities: CityData[] = [
  ...
  },
  {
    ...
    fr: {
      ...
      intro: 'Je travaille avec des entreprises et indépendants de la région grenobloise qui ont besoin d\'un site sérieux, sans se ruiner. Grenoble est une ville compétitive et votre site doit se démarquer. Je livre des sites clairs, rapides et optimisés Google, en moins de deux semaines.',
    ...
    en: {
      ...
      intro: 'I work with businesses and freelancers in the Grenoble area who need a serious website without breaking the bank. Grenoble is a competitive city and your site needs to stand out. I deliver clean, fast, Google-optimized sites in under two weeks.',
      breadcrumb: 'Web Designer Grenoble',
    },
  },
  {
