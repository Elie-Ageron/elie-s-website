...
/**
 * Les articles bilingues publies avant le pivot « reseaux sociaux » d'aout 2026.
 *
 * 🔴 Ils vivaient dans `blogPosts.ts`, qui importe aussi les vingt-quatre autres
 * fichiers d'articles pour construire le corpus complet. Consequence : impossible
 * de charger ces dix-sept articles sans charger les cent trente-neuf. Sortis
 * dans leur propre fichier le 16 septembre 2026 pour que `blogContent.ts`
 * puisse n'aller chercher que le fichier qui porte l'article demande.
 */
/**
...
export const legacyPosts: BlogPost[] = [
  {
    ...
    titleFr: 'Pourquoi votre entreprise a besoin d\'un site web',
    titleEn: 'Why your business needs a website',
    ...
    seoTitleFr: 'Pourquoi un Site Web Quand on a le Bouche à Oreille',
    seoTitleEn: 'Why a Website When Word of Mouth Works',
    seoDescFr: "On vous recommande, et la personne tape votre nom sur Google avant de vous appeler. Ce qu'elle trouve à cet instant décide de la suite, et souvent du prix.",
    seoDescEn: 'Someone recommends you, and that person types your name into Google before calling. What they find at that moment decides the rest, and often the price.',
    readTime: '5 min',
...
Want to talk it through? [Book a free call](/contact) and we will look at where you stand.
  ...
  },
  {
    ...
    seoTitleFr: 'Le Taux de Conversion se Joue en 5 Secondes',
    seoTitleEn: 'Optimise Your Conversion Rate | Elie Ageron',
    seoDescFr: "Ce qu'on comprend en cinq secondes sur le premier écran, puis la facilité de vous joindre. Ces deux points rapportent plus que tout le reste réuni.",
...
Want me to look at your site with you? [Write to me](/contact) and I will tell you what I would change first.
  ...
  },
  {
    ...
    seoTitleFr: 'En SEO Local, la Fiche Passe Avant le Site',
    seoTitleEn: 'Local SEO Complete Guide | Elie Ageron',
    seoDescFr: 'Fiche Google complète, avis récents, puis des pages qui nomment vos prestations et vos communes. Quelques semaines pour la fiche, trois à six mois pour le site.',
...
Want a hand with your local visibility? [Write to me](/contact) and we will look at your profile and your site together.
  ...
  },
  {
    ...
    seoTitleFr: 'Sur une Landing Page, Chaque Sortie Coûte',
    seoTitleEn: 'Anatomy of a Landing Page | Elie Ageron',
    seoDescFr: "Une page d'accueil oriente vers plusieurs destinations, une landing page en propose une seule et retire le reste, menu compris. Ce que porte le premier écran.",
...
Want a page that does that job? [Let's talk about your project](/contact).
  ...
  },
  {
    ...
    seoTitleFr: 'Combien Coûte un Site Web : 500 à 3 500 € en 2026',
    seoTitleEn: 'How Much Does a Website Cost? | Elie Ageron',
    seoDescFr: 'Une page unique démarre à 500 €, un site vitrine à 1 500 €, un pack de lancement à 3 500 €. Ce qui fait varier ce prix, et comment situer votre besoin.',
...
Want to know what a site could realistically do for your business? [Let's talk, it's free.](/contact)
  ...
  },
  {
    ...
    seoTitleFr: "Site d'Artisan : Choisir ses Clients, pas en Avoir Plus",
    seoTitleEn: 'Website for a Craftsperson | Elie Ageron',
    seoDescFr: "Même avec un carnet plein. Un artisan visible reçoit de meilleures demandes et négocie moins. Et c'est la personne à qui on vous recommande qui vérifie.",
...
You're a tradesperson and want to know what a website could change for you? [Let's talk, 30 minutes, free.](/contact)
  ...
  },
  {
    ...
    seoTitleFr: 'Site Absent de Google : le Vérifier en 10 Minutes',
    seoTitleEn: 'Site Not on Google: Check It in 10 Minutes',
    seoDescFr: "Le plus souvent le site est trop récent et Google ne l'a pas encore exploré. Le déclarer dans la Search Console prend dix minutes. L'ordre des vérifications.",
    seoDescEn: 'Most often the site is simply too new and Google has not crawled it yet. Declaring it in Search Console takes ten minutes. The order to check things in.',
    readTime: '7 min',
    categoryFr: 'SEO',
    categoryEn: 'SEO',
    date: '2026-04-19',
...
Your site isn't showing on Google and you want to understand why? [Let's look at it together.](/contact)
  ...
  },
  {
    ...
    seoTitleFr: 'Artisan en Savoie : les Réseaux Rassurent',
    seoTitleEn: 'Social Media for Trades in Savoie | Elie Ageron',
    seoDescFr: "Ils ne vendent pas directement. Ils servent à ce qu'on vous reconnaisse quand quelqu'un demande une recommandation, et à rassurer celui qui hésite à appeler.",
...
Want someone to handle it for you? [Here is how I work on social media](/reseaux-sociaux), or [write to me directly](/contact).
  ...
  },
  {
    ...
    seoTitleFr: 'La Taille du Compte ne Décide Plus des Vues',
    seoTitleEn: 'Short Video for Local Business | Elie Ageron',
    seoDescFr: "Une photo est servie à vos abonnés, une vidéo courte est testée sur des gens qui ne vous suivent pas. C'est ce qui a changé, et ce que ça ouvre aux petits.",
...
Want to see what it would look like for you? [The full service is here](/reseaux-sociaux).
  ...
  },
  {
    ...
    seoTitleFr: 'Combien Publier par Semaine : 2 à 3 Fois',
    seoTitleEn: 'How Often Should You Post? | Elie Ageron',
    seoDescFr: "Deux à trois fois, c'est le rythme qui tient quand les réseaux ne sont pas votre métier. Et pourquoi une publication par jour s'arrête au bout d'un mois.",
...
If keeping that rhythm feels impossible alongside your actual job, [that is exactly the problem I solve](/reseaux-sociaux).
  ...
  },
  {
    ...
    seoTitleFr: "Filmer au Téléphone, le Micro Avant l'Image",
    seoTitleEn: 'Filming on Your Phone | Elie Ageron',
    seoDescFr: 'Un mauvais son fait partir les gens avant une mauvaise image. Le seul achat qui change quelque chose, et la place à prendre par rapport à la fenêtre.',
...
[Here is how I handle it for clients](/reseaux-sociaux), one day a month.
  ...
  },
  {
    ...
    seoTitleFr: 'Un Thérapeute se Choisit sur un Visage et une Voix',
    seoTitleEn: 'Therapists: Social Media Clients | Elie Ageron',
    seoDescFr: "La décision d'appeler se joue sur la confiance, et elle se construit en voyant un visage et en entendant une voix. Comment publier sans jamais parler d'un cas.",
...
If you want someone to come film and post for you, [here is how it works](/reseaux-sociaux). And if you do not yet have a page to receive those people, [we can handle that too](/services).
  ...
  },
  {
    ...
    seoTitleFr: 'Ne Cherchez pas des Idées, Collectez des Questions',
    seoTitleEn: 'Social Media Content Ideas | Elie Ageron',
    seoDescFr: "Ne cherchez pas des idées. Notez pendant une semaine tout ce qu'un client vous demande, et vous aurez plus de sujets que vous ne pourrez en tourner.",
...
If you would rather not handle this part at all, [that is exactly what I do](/reseaux-sociaux): I arrive with the subjects, we film, and your videos go out all month.
  ...
  },
  {
    ...
    seoTitleFr: "Mes Vidéos ne Font pas de Vues : rien n'est Bridé",
    seoTitleEn: 'My Videos Get No Views | Elie Ageron',
    seoDescFr: "Une vidéo sans vues est une vidéo que l'échantillon a quittée, pas une sanction. Les cinq causes réelles, à commencer par un début qui démarre trop lentement.",
...
If you want to stop guessing, [I handle all of it](/reseaux-sociaux): the subject, the shoot, the edit and the posting.
  ...
  },
  {
    ...
    seoTitleFr: "Ayez d'Abord un Endroit où Renvoyer les Gens",
    seoTitleEn: 'Social Media or a Website? | Elie Ageron',
    seoDescFr: "Une page simple d'abord, puis la production de contenu une fois qu'elle est en ligne. L'inverse fait perdre les vues qu'on vient tout juste de gagner.",
...
Le montage, d'abord. D'une journée je sors huit vidéos verticales. Chacune est coupée pour tenir seule : une accroche dans les deux premières secondes, une idée, une fin nette.
...
Then you go back to work, and over the next four weeks your eight videos go out without you thinking about it.
...
[The full service is detailed here](/reseaux-sociaux), or [write to me directly](/contact).
  ...
  },
  {
    ...
    seoTitleFr: "L'Algorithme Compte le Temps, pas les J'aime",
    seoTitleEn: 'Understanding the Algorithm | Elie Ageron',
    seoDescFr: 'Votre publication est montrée à un petit groupe, la plateforme mesure combien de personnes restent, puis elle élargit ou elle arrête. Ce qui pèse vraiment.',
