...
const translations = {
  en: {
    ...
    'testimonial.1.role': 'Music Production Label',
    ...
    'portfolio.showcase.vmproducers.category': 'Music Production Label',
  ...
  fr: {
    ...
    'testimonial.1.author': 'VM Producers',
    'testimonial.1.founder': 'Austin Talley',
    'testimonial.1.role': 'Label de Production Musicale',
    'testimonial.1.date': 'Jan 2026',
    ...
    'portfolio.showcase.vmproducers.category': 'Label de Production Musicale',
