...
const translations = {
  en: {
    ...
    'why.pain2.desc': 'Without a website, clients can\'t check you out. They move on to someone they can verify online — and you never even know they were interested.',
  ...
  fr: {
    ...
    'why.pain2.desc': 'Sans site, les clients ne peuvent pas vous jauger. Ils passent à quelqu\'un qu\'ils peuvent vérifier en ligne — et vous ne saurez jamais qu\'ils s\'étaient intéressés.',
