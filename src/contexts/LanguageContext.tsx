...
const translations = {
  en: {
    ...
    'hero.proof.guarantee': 'Money-Back Guarantee',
    ...
    'home.valueProps.subtitle': 'A professional website is your most powerful business asset. Here\'s why.',
    ...
    'why.comparison.with': 'With Elie Ageron Design',
    ...
    'pricing.maintenance.toggle': 'Include Monthly Support',
    'pricing.maintenance.desc': 'Bug fixes, security updates, and hosting included. New features billed separately.',
    ...
    'contact.calendly.desc': 'Schedule a free 30-minute discovery call to discuss your project.',
  ...
  fr: {
    ...
    'hero.proof.guarantee': 'Satisfait ou remboursé',
    ...
    'home.valueProps.subtitle': 'Un site professionnel est votre atout business le plus puissant. Voici pourquoi.',
    ...
    'why.comparison.with': 'Avec Elie Ageron Design',
    ...
    'pricing.maintenance.toggle': 'Inclure le Support Mensuel',
    'pricing.maintenance.desc': 'Corrections de bugs, mises à jour de sécurité et hébergement inclus. Nouvelles fonctionnalités facturées à part.',
    ...
    'contact.calendly.desc': 'Planifiez un appel découverte gratuit de 30 minutes pour discuter de votre projet.',
