...
const translations = {
  en: {
    ...
    'apps.why.title': 'Not just another generic tool',
  ...
  fr: {
    ...
    'apps.types.badge': 'Services',
    'apps.types.title': 'Ce que je développe',
    ...
    'apps.why.title': 'Pas un outil générique de plus',
