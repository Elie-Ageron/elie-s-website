...
const translations = {
  en: {
    ...
    'home.cta.subtitle': 'Book a free 30-min call. I look at your situation and tell you exactly what can be done for you.',
    ...
    'why.benefit1.desc': 'When someone searches "plumber in Lyon" or "coach in Paris", they find you - not your competitor.',
    ...
    'pricing.quote.title': 'Specific needs?',
    'pricing.quote.title1': 'Specific',
    'pricing.quote.title2': 'needs?',
    'pricing.quote.desc': 'Your project doesn\'t fit these plans? Tell me what you need and I\'ll put together a custom quote, no obligation.',
    'pricing.quote.cta': 'Get a custom quote',
    'pricing.quote.q1': 'You already have a site and want to rebuild it?',
    'pricing.quote.q2': 'E-commerce, booking system, member area?',
    'pricing.quote.q3': 'You need something fully custom?',
    'pricing.quote.q4': 'Not sure what you need yet?',
    ...
    'portfolio.steel.desc': 'Trust-focused site that generates 50+ leads every month.',
    'portfolio.cta.title': 'Want Results Like These?',
    'portfolio.cta.subtitle': 'Let\'s talk about what we can do for your business.',
  ...
  fr: {
    ...
    'stats.mobile.desc': 'Votre site s\'affiche parfaitement sur téléphone, tablette et ordinateur. Tout le monde peut vous trouver, peu importe l\'appareil.',
    ...
    'portfolio.steel.desc': 'Un site conçu pour inspirer confiance et attirer plus de 50 contacts par mois.',
    'portfolio.cta.title': 'Vous voulez des résultats comme ça ?',
    'portfolio.cta.subtitle': 'Parlons de ce qu\'on peut concrètement faire pour vous.',
    ...
    'portfolio.showcase.mywebglory.desc': 'Un site conçu pour convertir les visiteurs en clients, avec un design moderne et une navigation pensée pour convaincre.',
    'portfolio.showcase.solarfusion.category': 'Énergie Solaire',
    'portfolio.showcase.solarfusion.cta': 'Découvrir Solar Fusion',
    'portfolio.showcase.solarfusion.desc': 'Un site professionnel pour un installateur de panneaux solaires, conçu pour attirer de nouveaux clients et inspirer confiance dès le premier regard.',
  },
};
