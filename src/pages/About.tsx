    ...
    ? [
        {
          ...
          body: [
            "Deux choses, de poids égal. Je construis des sites pour des entreprises qui n'ont pas de service communication, et je produis le contenu vidéo de leurs réseaux sociaux. Pour ce second point, je viens filmer une journée par mois sur place, puis je monte, je sous-titre, j'écris et je publie huit vidéos dans le mois. Le client ne touche à rien.",
    ...
    : [
        {
          ...
          body: [
            'Two things, equally weighted. I build websites for businesses with no communications team, and I produce the video content for their social media. For the second, I come and film on site for one full day each month, then edit, subtitle, write and publish eight videos over the month. The client touches nothing.',
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 relative z-10">
          <motion.header initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <p className="mt-5 text-base sm:text-lg text-muted-foreground leading-relaxed">
              {fr
                ? "Je construis des sites pour des entreprises locales et je m'occupe de leurs réseaux sociaux. Une journée de tournage par mois chez elles, et huit publications dans le mois ensuite, sans qu'elles aient à filmer ou monter quoi que ce soit."
                : 'I build websites for local businesses and run their social media. One day of filming at their place each month, then eight videos posted over that month, without them having to film or edit anything.'}
            </p>
          </motion.header>
        </div>
      </section>
