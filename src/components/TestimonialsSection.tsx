...
const TestimonialCard = ({ text, author, role, delay, index }: TestimonialCardProps) => {
  ...
  return (
    ...
    >
      ...
      {/* Testimonial Text */}
      <motion.p 
        className="text-foreground/90 text-lg mb-6 leading-relaxed relative z-10"
        initial={{ opacity: 0 }}
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
        transition={{ delay: delay * 0.15 + 0.4 }}
      >
        <motion.div 
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
        transition={{ delay: delay * 0.15 + 0.5, duration: 0.8 }}
      />
    </motion.div>
  );
};
